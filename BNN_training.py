...
history = model.fit(X_train,y_train,epochs=100,batch_size=100,validation_data=(X_test,y_test),verbose=1,callbacks=[lr_scheduler])
...
#model.save('./models/mnist_nn.h5') #This is to save the model
model.save_weights('./models/mnist_nn_binaryweights2.h5') # Edit this to save your own weights file
