...
def build_model():
 ...
 # Please put your weights file into this area
...
class ImageGenerator:
    ...
    def minst_nn_pred(self):
        ...
        model1 = build_model()
        model1.load_weights('./models/mnist_nn_quantized_zeroone_FC.h5')
...
"""
    model = Sequential()
    model.add(Dense(512, input_shape=(784,), use_bias=use_bias, activation='sigmoid'))
    model.add(Dense(512, use_bias=use_bias, activation='sigmoid'))
    model.add(Dense(512, use_bias=use_bias, activation='sigmoid'))
